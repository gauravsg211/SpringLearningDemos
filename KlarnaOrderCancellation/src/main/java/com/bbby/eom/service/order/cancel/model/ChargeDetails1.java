...
public class ChargeDetails1 {

    @XmlElement(name = "ChargeDetail_211")
    protected List<ChargeDetail211> chargeDetail211;

    /**
     * Gets the value of the chargeDetail211 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the chargeDetail211 property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChargeDetail211().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ChargeDetail211 }
     * 
     * 
     */
    public List<ChargeDetail211> getChargeDetail211() {
        if (chargeDetail211 == null) {
            chargeDetail211 = new ArrayList<ChargeDetail211>();
        }
        return this.chargeDetail211;
    }
