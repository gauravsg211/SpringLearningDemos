...
public class ChargeDetails2 {

    @XmlElement(name = "ChargeDetail_7")
    protected List<ChargeDetail7> chargeDetail7;

    /**
     * Gets the value of the chargeDetail7 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the chargeDetail7 property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChargeDetail7().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ChargeDetail7> getChargeDetail7() {
        if (chargeDetail7 == null) {
            chargeDetail7 = new ArrayList<ChargeDetail7>();
        }
        return this.chargeDetail7;
    }
