...
public class DiscountDetails2 {

    @XmlElement(name = "DiscountDetail_3")
    protected List<DiscountDetail3> discountDetail3;

    /**
     * Gets the value of the discountDetail3 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the discountDetail3 property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDiscountDetail3().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DiscountDetail3 }
     * 
     * 
     */
    public List<DiscountDetail3> getDiscountDetail3() {
        if (discountDetail3 == null) {
            discountDetail3 = new ArrayList<DiscountDetail3>();
        }
        return this.discountDetail3;
    }
